...
const Navbar2 = () => {
  ...
  return (
    ...
    <div className="flex flex-[4] justify-center items-center">
        <div className="mr-[20px] w-[30px] h-[30px] bg-white rounded-full relative cursor-pointer"><BiLogoTwitter color='black' className='w-[23px] h-[23px] absolute left-1 top-1' /></div>
        <div className="mr-[20px] w-[30px] h-[30px] bg-white rounded-full relative cursor-pointer"><BiLogoInstagramAlt color='black' className='w-[23px] h-[23px] absolute left-1 top-1'/></div>
        <div className="mr-[20px] w-[30px] h-[30px] bg-white rounded-full relative cursor-pointer"><BiLogoYoutube color='black' className='w-[23px] h-[23px] absolute left-1 top-1'/></div>
    </div>
    {session && session.user ? (
        ...
        <div className="w-1/5 h-15 flex justify-between gap-2  items-center border border-gray-600 rounded-full">
          ...
          <div className="ml-[10px] mr-[5px] cursor-pointer"><IoHeart className='w-6 h-6 bg-white rounded-full p-1' color='black'/></div>
          <div className="ml-[5px] mr-[3px] cursor-pointer flex">
            <Link className="rounded-btn" href="/allproducts/cart">
             <MdShoppingBag className='w-6 h-6 bg-white rounded-full p-1' color='black'/>
